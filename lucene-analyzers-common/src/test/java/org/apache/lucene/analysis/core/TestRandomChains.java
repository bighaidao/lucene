...
public class TestRandomChains extends BaseTokenStreamTestCase {
  ...
  private static final Set<Class<?>> brokenComponents = new MapBackedSet<Class<?>>(new IdentityHashMap<Class<?>,Boolean>());
  static {
  ...
  private static final Set<Class<?>> brokenOffsetsComponents = new MapBackedSet<Class<?>>(new IdentityHashMap<Class<?>,Boolean>());
  static {
  ...
  private static void getClassesForPackage(String pckgname, List<Class<?>> classes) throws Exception {
    ...
    while (resources.hasMoreElements()) {
      ...
      final File directory = new File(u.toURI());
      if (directory.exists()) {
  ...
  static {
    allowedTokenizerArgs = new MapBackedSet<Class<?>>(new IdentityHashMap<Class<?>,Boolean>());
    ...
    allowedTokenFilterArgs = new MapBackedSet<Class<?>>(new IdentityHashMap<Class<?>,Boolean>());
    allowedTokenFilterArgs.addAll(argProducers.keySet());
    allowedTokenFilterArgs.add(TokenStream.class);
    
    allowedCharFilterArgs = new MapBackedSet<Class<?>>(new IdentityHashMap<Class<?>,Boolean>());
  ...
  static class MockRandomAnalyzer extends ReusableAnalyzerBase {
    final long seed;
