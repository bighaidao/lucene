...
public class TestQPHelper extends LuceneTestCase {
  ...
  public void testCJKTerm() throws Exception {
    ...
    inner.add(new TermQuery(new Term("field", "\u00c2\u00f5\u03a9")), BooleanClause.Occur.SHOULD);
    expected.add(inner, BooleanClause.Occur.MUST);
    // disabled, some unicode thing?
    // java.lang.AssertionError: expected:<+field:中 +(field:中 field:国)> but was:<field:##?>
    //assertEquals(expected, getQuery("\u2030\u220f\u2260 AND \u2030\u220f\u2260\u00c2\u00f5\u03a9", analyzer));
  }
